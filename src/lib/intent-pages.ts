export const intentPages = {
  sell: {
    ...
    intro:
      "List what still works—from one shoe or a spare remote to furniture, electronics, clothing, and household items—and speak directly with interested people.",
  ...
  trade: {
    ...
    intro:
      "Show what you have, say what you need, and speak directly with someone open to the same swap.",
  ...
  donate: {
    ...
    intro:
      "List the useful thing you can spare, find someone who needs it, and agree on collection or delivery directly.",
  ...
  repair: {
    ...
    intro:
      "A damaged item may still be repairable—or contain the exact part someone needs. Show its condition clearly and find the right person.",
  ...
  recycle: {
    ...
    intro:
      "When an item cannot be reused as it is, its parts and materials can still help a recycler, maker, or repairer. List it clearly so they can find it.",
