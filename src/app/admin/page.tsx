...
export default function AdminPage() {
  ...
  if (!hasHydrated || !authorized) {
    return <LoadingState label="Checking administrator access" className="min-h-[55vh]" />;
  }
  ...
  return (
    <main className="mx-auto min-h-screen max-w-7xl px-3 pb-24 pt-4 md:px-8 md:pb-12 md:pt-8">
      ...
      {loading && activeTab !== "overview" ? <LoadingState label="Loading administration data" compact className="min-h-56" /> : null}
